                    ...
                    <div class="d-table">
                        <div class="d-table-cell">
                            <div class="login-form" style="max-width:70%;">
                                <form action="{{ route('user.job.update',$job) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="name" id="name" placeholder="Your job name"
                                                    class="form-control" required value="{{ $job->name }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <textarea type="text" name="details" id="bio" placeholder="Your job details" rows="4" class="form-control">
                                            {!! $job->details !!}
                                        </textarea>
                                    </div>
