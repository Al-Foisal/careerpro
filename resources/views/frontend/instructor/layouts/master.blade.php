...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        @include('frontend.instructor.layouts.partials._navbar')
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        @include('frontend.instructor.layouts.partials._sidebar')
        ...
        <!-- Control Sidebar -->
        @include('frontend.instructor.layouts.partials._control-sidebar')
        <!-- /.control-sidebar -->

        <!-- Main Footer -->
        @include('frontend.instructor.layouts.partials._footer')
    </div>
    <!-- ./wrapper -->
