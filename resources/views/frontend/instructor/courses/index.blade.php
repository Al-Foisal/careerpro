            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('instructor.courses.create') }}" class="btn btn-outline-primary">Add
                                Courses</a>
                            <br>
                            <br>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @if ($course->status === 1)
                                                            <form
                                                                action="{{ route('instructor.courses.inactive', $course) }}"
                                                                method="post">
                                                                @csrf
                                                        ...
                                                        @else
                                                            <form
                                                                action="{{ route('instructor.courses.active', $course) }}"
                                                                method="post">
                                                                @csrf
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('instructor.courses.edit', $course->slug) }}">Edit
                                                            Course</a>

                                                        <a class="dropdown-item"
                                                            href="{{ route('instructor.courses.assignment', $course->slug) }}">Assignment</a>

                                                        <form action="{{ route('instructor.courses.delete', $course) }}"
                                                            method="delete">
                                                            @csrf
