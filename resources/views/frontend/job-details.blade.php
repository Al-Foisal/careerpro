                                            ...
                                            <div class="d-table">
                                                <div class="d-table-cell">
                                                    <div class="login-form">
                                                        <form action="{{ route('storeApplication',$job->id) }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            ...
                                                            <div class="form-group">
                                                                <label for="file" style="float: left;">Place Your CV</label>
                                                                <input type="file" name="cv" id="file" placeholder="Your CV" accept="application/pdf" 
                                                                    class="form-control" required>
                                                            </div>
