...
@section('title', 'Walk In Interview Job Post')
@section('css')
    <style>
        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li>Walk In Interview Jobs</li>
                </ul>
                <h2>Walk In Interview Job List</h2>
            </div>
        </div>
    </div>
    <!-- End Page Title Area -->
                                    ...
                                    <div class="box-item">
                                        ...
                                        <div class="courses-desc">
                                            ...
                                            <div class="courses-box-footer">
                                                <a href="{{ route('jobDetails', $job->id) }}" class="apply">View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
